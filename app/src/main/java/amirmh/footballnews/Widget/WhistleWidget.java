 ...
 * App Widget Configuration implemented in { WhistleWidgetConfigureActivity WhistleWidgetConfigureActivity}
 */
public class WhistleWidget extends AppWidgetProvider {

    private RemoteViews updateWidgetListView(Context context, int appWidgetId) {

        //which layout to show on widget
        RemoteViews remoteViews = new RemoteViews(context.getPackageName(),
                R.layout.whistle_widget);
